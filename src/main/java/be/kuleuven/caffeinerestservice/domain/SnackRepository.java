...
public class SnackRepository {
    ...
    public Map<String, Integer> getStock() {
        ...
        for (Map.Entry<String, Integer> entry : stock.entrySet()) {
            ...
            findSnack(id).ifPresent(snack -> result.put(snack.getName(), quantity));
        }
        return result;
    }
    ...
    public Map<String, Integer> findStock(String id) {
        ...
        Snack d = findSnack(id).orElseThrow(() -> new DrinkNotFoundException(id));
        Map<String, Integer> result = new HashMap<>();
    ...
    public Optional<Snack> findSnack(String id) {
        ...
        return Optional.ofNullable(snack);
    }
    ...
    public boolean reserveItem(String id, String resId) {
        Assert.notNull(id, "The id must not be null");
    ...
    public boolean checkReservation(String reservationId, String id) {
        ...
        for (Reservation res : reservations) {
            if (res.getReservationId().equals(reservationId) && res.getSnackId().equals(id)) {
                return true;
            }
        }
        return false;
    ...
    public void getReserved() {
        ...
        for (Reservation reservation : reservations) {
            System.out.println("Reserved " + reservation.getSnackId() + " | Reservation ID: " + reservation.getReservationId());
        }
    }
